...
export default function CustomerAnalytics() {
    ...
    const membershipStatusData = [{ name: "Active", value: analytics.activeCustomers }, { name: "Expiring", value: analytics.expiringCustomers }, { name: "Expired", value: analytics.expiredCustomers }];
